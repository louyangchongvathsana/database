...
--sales.customers
SELECT customer_id'ລະຫັດລູກຄ້າ',first_name'ຊື່ລູກຄ້າ',last_name'ນາສະກຸມ', phone'ເບີ', email'ເມວ', street'ຖາໜົນ',city'ເມືອງ', state'ລັດ',zip_code'ລະຫັດປະເທດ' FROM sales.customers

--sales.stores
SELECT store_id 'ລະຫັດຮ້ານ', store_name 'ຊື່ຮ້ານ', phone 'ເບີໂທ', email 'ເມວ',street 'ຖະໜົນ', city 'ເມືອງ', zip_code 'ລະຫັດປະເທດ' FROM sales.stores
